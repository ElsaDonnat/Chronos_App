...
const LEVEL2_MEDICINE_CONNECTIONS = {
    f207: [
        ...
        { id: "f208", label: "Indian surgery developed independently around the same era" },
    ],
    f208: [
        { id: "f207", label: "Indian and Egyptian medicine represent two independent ancient traditions" },
        { id: "f209", label: "India and China each developed holistic medical systems independently" },
    ],
    f209: [
        { id: "f208", label: "Chinese and Indian medicine evolved in parallel as holistic systems" },
        { id: "f14", label: "Chinese medicine developed during the Axial Age\u2019s intellectual flowering" },
        { id: "f210", label: "Chinese medical knowledge eventually reached the Islamic world via the Silk Road" },
    ],
    f210: [
        { id: "f209", label: "Avicenna synthesized Greek, Indian, and Chinese medical knowledge" },
        { id: "f211", label: "Islamic medical understanding of contagion influenced quarantine practices" },
        { id: "f212", label: "The Canon remained the standard until Vesalius challenged ancient authority" },
    ],
    f211: [
        { id: "f30", label: "Quarantine was a direct response to the devastation of the Black Death" },
        { id: "f210", label: "Islamic medicine\u2019s understanding of contagion influenced quarantine thinking" },
    ...
    f212: [
        ...
        { id: "f210", label: "Vesalius challenged the Galenic anatomy that Avicenna had preserved" },
        { id: "f215", label: "Anatomical knowledge was essential for understanding how germs attack the body" },
    ],
    f213: [
        { id: "f214", label: "Semmelweis and Nightingale independently proved sanitation saves lives" },
        { id: "f215", label: "Semmelweis discovered the practice; Pasteur later provided the theory" },
        { id: "f101", label: "Semmelweis\u2019s handwashing and Snow\u2019s cholera map both showed disease had physical causes" },
    ],
    f214: [
        { id: "f213", label: "Nightingale and Semmelweis both demonstrated sanitation\u2019s life-saving power" },
        { id: "f215", label: "Nightingale\u2019s sanitation reforms anticipated the germ theory Pasteur would prove" },
        { id: "f216", label: "Nightingale\u2019s vision of public health as a system inspired global health institutions" },
    ],
    f215: [
        { id: "f213", label: "Germ theory explained why Semmelweis\u2019s handwashing had worked" },
    ...
    f216: [
        ...
        { id: "f214", label: "Nightingale\u2019s vision of systematic public health found its global expression in the WHO" },
    ],
    // Cross-connections: append to existing events
    f8: [
        { id: "f207", label: "Egyptian civilization also produced the world\u2019s first named physician" },
    ],
    f14: [
        { id: "f209", label: "The Axial Age saw the systematization of Chinese medical theory" },
    ],
    f30: [
        { id: "f211", label: "The Black Death\u2019s devastation led to the invention of quarantine" },
    ],
    f38: [
        { id: "f212", label: "Vesalius\u2019s anatomical revolution was part of the Scientific Revolution" },
    ],
    f54: [
        { id: "f216", label: "The UN created the WHO to make health a global responsibility" },
    ],
    f100: [
        { id: "f215", label: "Pasteur built on Jenner\u2019s vaccination principle with germ theory" },
    ],
    f101: [
        { id: "f213", label: "Snow and Semmelweis independently proved disease has physical, preventable causes" },
    ],
};
...
const IMPORTANCE_MAP = {
    ...
    f210: 'major', f215: 'major', f216: 'major',
...
export const CORE_EVENT_COUNT = CORE_EVENTS.length; // 216 (60 Level 1 + 156 Level 2)
