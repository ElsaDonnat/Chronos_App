...
- Pinch-zoom via CSS `transform: scale()` + custom touch pan handler (max 4×); desktop wheel zoom via `onWheel`; double-tap to zoom (2× centered on tap point, double-tap again resets)
