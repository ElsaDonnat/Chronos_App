...
Casual endless MCQ quiz in the Practice hub. 10 curated trivia questions tied to specific event cards. Each fun fact has a question, 4 options (1 correct + 3 wrong), and a "Did you know?" explanation. Facts cover surprising details NOT found in card descriptions.
