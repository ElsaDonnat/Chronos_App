...
const ICONS = [
    ...
    // 10: castle
    <g><rect x="4" y="10" width="16" height="11" rx="1" fill={FC} opacity="0.28" /><path d="M4 21h16V10H4z" /><path d="M4 10V6h3v4" /><path d="M10 10V6h4v4" /><path d="M17 10V6h3v4" /><rect x="10" y="16" width="4" height="5" /></g>,
    // 11: dagger
    ...
    // 14: ship
    <g><path d="M3 18l2-4h14l2 4" fill={FC} opacity="0.25" /><path d="M3 18l2-4h14l2 4" /><line x1="12" y1="14" x2="12" y2="5" /><path d="M12 5l6 4H12z" fill={FC} opacity="0.32" /><path d="M12 5l6 4H12" /><path d="M2 21c2-1 4-1 5 0s3 1 5 0 3-1 5 0 3 1 5 0" /></g>,
    // 15: telescope
    ...
    // 17: factory
    <g><rect x="2" y="12" width="20" height="9" rx="1" fill={FC} opacity="0.26" /><path d="M2 21h20V12H2z" /><path d="M6 12V4l5 4V4l5 4V4l4 3v5" /><rect x="6" y="16" width="3" height="3" /><rect x="12" y="16" width="3" height="3" /></g>,
    // 18: bomb
...
const FALLBACK = <g><rect x="4" y="4" width="16" height="16" rx="2" /><line x1="8" y1="10" x2="16" y2="10" /><line x1="8" y1="14" x2="14" y2="14" /></g>;
