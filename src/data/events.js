...
const CORE_EVENTS = [
    ...
    },
    {
        ...
        description: "The first expedition to sail around the entire globe, providing the first proof by circumnavigation that the Earth was round, and connecting the Americas to Asia in the first truly global trade network.",
        quizDescription: "The first voyage around the globe proved Earth's roundness by circumnavigation.",
